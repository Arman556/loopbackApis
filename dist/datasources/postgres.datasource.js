...
const postgres_datasource_config_json_1 = tslib_1.__importDefault(require("./postgres.datasource.config.json"));
let PostgresDataSource = class PostgresDataSource extends repository_1.juggler.DataSource {
    constructor(dsConfig = postgres_datasource_config_json_1.default) {
        super(dsConfig);
    }
    /**
